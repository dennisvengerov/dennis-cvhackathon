...
- **F1 app/api/checkout.py**: Contains checkout_endpoint (Semantic Card relevance 1.0 (Node matches task keywords: checkout.); Keyword matches: endpoint, checkout, request; Checkout component match; Route/Endpoint checkout handler boost; Validation/Schema component match)
...
**Nodes Selected:**
- **N3 app.api.checkout::checkout_endpoint** (score: 180.40): Semantic Card relevance 1.0 (Node matches task keywords: checkout.); Keyword matches: endpoint, checkout, request; Checkout component match; Route/Endpoint checkout handler boost; Validation/Schema component match
